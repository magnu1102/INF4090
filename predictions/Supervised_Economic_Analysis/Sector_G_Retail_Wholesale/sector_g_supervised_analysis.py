"""
Sector G (Retail/Wholesale) - Supervised Economic Analysis
===========================================================
...
print("="*80)
print("SECTOR G (RETAIL/WHOLESALE) - SUPERVISED ECONOMIC ANALYSIS")
print("="*80)
...
# Extract NACE and filter to Retail/Wholesale (45-47)
...
sector_df = df_all[(df_all['nace_code'] >= 45) & (df_all['nace_code'] <= 47)].copy()
...
output_dir = Path(r'C:\Users\magnu\Desktop\AI Management\INF4090\predictions\Supervised_Economic_Analysis\Sector_G_Retail_Wholesale')
