"""
Sector I (Hospitality) - Supervised Economic Analysis
======================================================
...
print("="*80)
print("SECTOR I (HOSPITALITY) - SUPERVISED ECONOMIC ANALYSIS")
print("="*80)
...
# Extract NACE and filter to Hospitality (55-56)
...
output_dir = Path(r'C:\Users\magnu\Desktop\AI Management\INF4090\predictions\Supervised_Economic_Analysis\Sector_I_Hospitality')
