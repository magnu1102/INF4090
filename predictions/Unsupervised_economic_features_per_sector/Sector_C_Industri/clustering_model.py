"""
Unsupervised Learning: Pure Economic Features - Sector C (Industri)
====================================================================

NACE Codes: 10-33 (Manufacturing/Industry)

Features Used:
- ALL raw accounting numbers (Tall fields)
- ALL financial ratios (11 ratios)
...
print("="*80)
print("UNSUPERVISED CLUSTERING: SECTOR C (INDUSTRI) - PURE ECONOMIC FEATURES")
print("="*80)
...
# Extract NACE code and filter to Sector C (Industri: 10-33)
...
# 2. FINANCIAL RATIOS (all 11 ratios)
financial_ratios = [
    'likviditetsgrad_1',
    'total_gjeldsgrad',
