"""
Unsupervised Learning: Pure Economic Features - Sector F (Construction)
========================================================================

NACE Codes: 41-43 (Construction and Civil Engineering)
...
print("="*80)
print("UNSUPERVISED CLUSTERING: SECTOR F (CONSTRUCTION) - PURE ECONOMIC FEATURES")
print("="*80)
...
# Extract NACE code and filter to Sector F (Construction: 41-43)
